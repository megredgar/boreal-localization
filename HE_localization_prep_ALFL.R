## ---------------------------------------------------------------
## Localization prep: ALFL (Alder Flycatcher)
## Converts HawkEars detections -> aru_coords.csv + detections_ALFL.csv
...
out_dir <- "D:/BARLT Localization Project/localization_05312025/hawkears_0_7_ALFL"
...
cat(sprintf("ALFL detections after threshold (%.2f): %d\n", threshold, nrow(det)))
...
## ---- build detections_ALFL.csv (3 s bins) ---------------------
